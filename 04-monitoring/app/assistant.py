...
ELASTIC_URL = os.getenv("ELASTIC_URL", "http://elasticsearch:9200") ## "http://localhost:9200" 
OLLAMA_URL =  os.getenv("OLLAMA_URL", "http://ollama:11434/v1/") ## "http://localhost:11434/v1/"
